...
const growth_levels = [
  ...
  {growth_level: 2, 
  plantImg: src ="plants/plantImg2.png"},
  {growth_level: 3, 
  plantImg: src ="plants/plantImg3.png"},
  {growth_level: 4, 
  plantImg: src ="plants/plantImg4.png"},
  {growth_level: 5, 
  plantImg: src ="plants/plantImg5.png"},
  {growth_level: 6, 
  plantImg: src ="plants/plantImg7.png"},
  {growth_level: 7, 
  plantImg: src ="plants/plantImg7.png"},
  {growth_level: 8, 
  plantImg: src ="plants/plantImg8.png"},
  {growth_level: 9, 
  plantImg: src ="plants/plantImg9.png"},
  {growth_level: 10, 
  plantImg: src ="plants/plantImg10.png"},
  {growth_level: 11, 
  plantImg: src ="plants/plantImg11.png"},
  {growth_level: 12, 
  plantImg: src ="plants/plantImg12.png"},
  {growth_level: 13, 
  plantImg: src ="plants/plantImg13.png"},
  {growth_level: 14, 
  plantImg: src ="plants/plantImg14.png"},
  {growth_level: 15, 
  plantImg: src ="plants/plantImg15.png"},
  {growth_level: 16, 
  plantImg: src ="plants/plantImg16.png"},
  {growth_level: 17, 
  plantImg: src ="plants/plantImg17.png"},
  {growth_level: 18, 
  plantImg: src ="plants/plantImg18.png"},
  {growth_level: 19, 
  plantImg: src ="plants/plantImg19.png"},
  {growth_level: 20, 
  plantImg: src ="plants/plantImg20.png"},
  {growth_level: 21, 
  plantImg: src ="plants/plantImg21.png"},
  {growth_level: 22, 
  plantImg: src ="plants/plantImg22.png"},
  {growth_level: 23, 
  plantImg: src ="plants/plantImg23.png"},
  {growth_level: 24, 
  plantImg: src ="plants/plantImg24.png"},
  {growth_level: 25, 
  plantImg: src ="plants/plantImg25.png"},
  {growth_level: 26, 
  plantImg: src ="plants/plantImg26.png"},
  {growth_level: 27, 
  plantImg: src ="plants/plantImg27.png"},
  {growth_level: 28, 
  plantImg: src ="plants/plantImg28.png"},
  {growth_level: 29, 
  plantImg: src ="plants/plantImg29.png"},
  {growth_level: 30, 
  plantImg: src ="plants/plantImg30.png"},
  {growth_level: 31, 
  plantImg: src ="plants/plantImg31.png"},
  {growth_level: 32, 
  plantImg: src ="plants/plantImg32.png"},
  {growth_level: 33, 
  plantImg: src ="plants/plantImg33.png"},
  {growth_level: 34,
  plantImg: src="plants/plantImg34.png"},
  {growth_level: 35,
  plantImg: src="plants/plantImg35.png"},
  {growth_level: 36,
  plantImg: src="plants/plantImg36.png"},
  {growth_level: 37,
  plantImg: src="plants/plantImg37.png"},
  {growth_level: 38,
  plantImg: src="plants/plantImg38.png"},
  {growth_level: 39,
  plantImg: src="plants/plantImg39.png"},
  {growth_level: 40,
  plantImg: src="plants/plantImg40.png"},
  {growth_level: 41,
  plantImg: src="plants/plantImg41.png"},
  {growth_level: 42,
  plantImg: src="plants/plantImg42.png"},
  {growth_level: 43,
  plantImg: src="plants/plantImg43.png"},
  {growth_level: 44,
  plantImg: src="plants/plantImg44.png"},
  {growth_level: 45,
  plantImg: src="plants/plantImg45.png"},
  {growth_level: 46,
  plantImg: src="plants/plantImg46.png"},
  {growth_level: 47,
  plantImg: src="plants/plantImg47.png"},
  {growth_level: 48,
  plantImg: src="plants/plantImg48.png"},
  {growth_level: 49,
  plantImg: src="plants/plantImg49.png"},
  {growth_level: 50,
  plantImg: src="plants/plantImg50.png"},
  {growth_level: 51,
  plantImg: src="plants/plantImg51.png"}
]
